...
```
cd dotnet-docs-samples/retail/interactive-tutorial
```
```
...
<!--TODO update the command when the files will be merged-->
    ```bash
...
To run the code in class SearchSimpleQuery.cs run command:
```
